...
function showAboutIntroductionTexts() {
  if (!aboutSectionEntered) {
    new Typed("#work", {
      strings: [
        "Currently working as a @ <span class = 'color-primary'>Freelancer</span>",
      ],
      typeSpeed: 10,
      loop: false,
      startDelay: 0,
      ...
      onComplete: function () {
        new Typed(".office-text", {
          strings: [
            "Devoting office hours into developing apps.",
          ],
          typeSpeed: 10,
          loop: false,
          startDelay: 0,
          ...
          onComplete: function () {
            new Typed(".spare-text", {
              strings: [
                "In my spare time, I <span class = 'color-primary'>develop</span> iOS apps, android apps and <span class = 'color-primary'>explore</span> tech.",
              ],
              typeSpeed: 10,
              loop: false,
              startDelay: 0,
                        ...
                        new Typed(".game-text", {
                          ...
                          onComplete: function () {
                            new Typed(".contribution-text", {
                              strings: [
                                "I've recently created a <a href='https://www.linkedin.com/in/aarfeen-ahmad-066b74110' target='_blank'><span class = 'color-palatte-4'> LinkedIn</span></a> handle to share my knowledge, connect with awesome people, and help other developers with iOS dev.",
                              ],
                              typeSpeed: 10,
                              loop: false,
                              startDelay: 0,
